...
<ol>
  ...
  marign위로 올라가는 일이 생겨서 hidden을 넣었다가 뒤 두 그룹이 사라지는 일이 생겨서 여러가지 만지다가 나오긴 했음 그치만 넘길 때 마다<br> 
  마진 뒤로 가버려서 js를 수정해서 100만큼이 아니라 85만큼(, 170만큼) 움직이도록 함 아마 나머지 15vw는 마진 듯 함</li>
